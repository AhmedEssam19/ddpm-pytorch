...
from torchvision.transforms import ToTensor, Compose, Lambda, ToPILImage, Resize, RandomHorizontalFlip
...
def main(
    ...
    channels_multiplier: list[int] = [1, 1, 2, 2, 4, 4],
    ...
    dataset = CelebADataset(timesteps=timesteps, transform=transform)
